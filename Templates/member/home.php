...
<div class="container-sm">
    <div class="row">
        <div class="col-sm-12">
            <?php global $name; ?>
            <h1><?php echo "Welkom " . $name?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <p class="fs-5">Autobedrijf Snel Weg is een automobielbedrijf met zeer interessante occasions op voorraad. Met ruim 20 occasions en een snel wisselende voorraad in alle
